...
public actual class AttestationProviderMock : AttestationProvider {
    override suspend fun getAttestation(nonce: Hash, publicKey: ByteArray): Attestation {
        return Attestation(
            publicKey = CryptoUtils.encodeToBase64(publicKey), attestation = CryptoUtils.encodeHashedToBase64(nonce),
